...
if ($_POST['add'] ?? false) {
  ...
  $estoque_minimp_esmalte = $_POST['estoque_minimp'];
  
  // Inserir nova pizza no banco
  $sql = "INSERT INTO pizzas (nome, cores, preco, categorias, marcas, estoque_minimp) 
      VALUES ('$nome_pizza', '$cores_pizza', $preco_pizza, '$categorias_pizza', '$marcas_pizza', $estoque_minimp_pizza)";
  $conn->query($sql);
...
/* ===== TABELA COM VISUAL DO MOVIMENTACOES.PHP ===== */
table {
  width: 100%;
